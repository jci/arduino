...
const char *ssid = "codem0nkeys";
const char *password = "11566848";

const char *HOSTNAME = "esp8266"; // example for http://esp8266.local/

static char const consumer_key[]    = "ZcW3Ne8IyQos2NLhEvdZp12Pn";
static char const consumer_sec[]    = "G9TkOPMB4fLjc0S0t1YOiGbCeg1pxedaI9kcG7yv3VpMHatlil";
static char const accesstoken[]     = "3947311-d9dOM5Vq7ggHUSEtRmA0H8NFFtSCqBtvPaRtiTjtvP";
static char const accesstoken_sec[] = "g9oM8EGcemMfUJvAadKrgsSGyZAraMCKLkwBg4RXkO0w1";
